...
Before the game starts, split the cards so each player has their own deck ([your puzzle input](data/input.txt)). Then, the game consists of a series of rounds: both players draw their top card, and the player with the higher-valued card wins the round. The winner keeps both cards, placing them on the bottom of their own deck so that the winner's card is above the other card. If this causes a player to have all of the cards, they win, and the game ends.
...
[Solution Part 1](part1.js) // 33631
